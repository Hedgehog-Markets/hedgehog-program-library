...
// Accounts.
export interface CreateMarketV1InstructionAccounts {
  /** Program config */
...
// Data.
export interface CreateMarketV1InstructionData {
...
export interface CreateMarketV1InstructionDataArgs {
  resolver: PublicKey;
