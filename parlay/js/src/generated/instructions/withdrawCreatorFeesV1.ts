...
// Accounts.
export interface WithdrawCreatorFeesV1InstructionAccounts {
  /** User */
  user?: PublicKey | Pda;
  /** Token mint */
  mint: PublicKey | Pda;
...
// Data.
export interface WithdrawCreatorFeesV1InstructionData {
  discriminator: number;
}

export interface WithdrawCreatorFeesV1InstructionDataArgs {}
