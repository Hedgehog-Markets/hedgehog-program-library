...
import type { Event, EventArgs } from "../../hooked";
import type { AccountTypeArgs, HighScore, HighScoreArgs, State, StateArgs } from "../types";
import type {
  Account,
  Amount,
  Context,
...
import { getEventSerializer } from "../../hooked";
import {
  AccountType,
  getAccountTypeSerializer,
  getHighScoreSerializer,
  getStateSerializer,
} from "../types";

export type MarketV1 = Account<MarketV1AccountData>;

export interface MarketV1AccountData {
...
export interface MarketV1AccountDataArgs {
  creator: PublicKey;
  index: number;
  resolver: PublicKey;
  mint: PublicKey;
  nextEntry: number;
  entryCost: number | bigint;
  creatorFee: Amount<"%", 2>;
  platformFee: Amount<"%", 2>;
  ...
  state: StateArgs;
  highScore: HighScoreArgs;
  events: Array<EventArgs>;
  uri: string;
}
  ...
  return mapSerializer<MarketV1AccountDataArgs, any, MarketV1AccountData>(
    struct<MarketV1AccountData>(
      [
        ...
        ["highScore", getHighScoreSerializer()],
        ["events", array(getEventSerializer(), { size: u8() })],
        ["uri", string()],
      ],
...
export function getMarketV1GpaBuilder(context: Pick<Context, "rpc" | "programs">) {
  ...
  return gpaBuilder(context, programId)
    .registerFields<{
      ...
      nextEntry: [101, u32()],
      entryCost: [105, u64()],
      creatorFee: [113, mapAmountSerializer(u16(), "%", 2)],
      platformFee: [115, mapAmountSerializer(u16(), "%", 2)],
      creationTimestamp: [117, i64()],
      closeTimestamp: [125, i64()],
      resolveTimestamp: [133, i64()],
      outcomeTimestamp: [141, i64()],
      state: [149, getStateSerializer()],
      highScore: [150, getHighScoreSerializer()],
      events: [155, array(getEventSerializer(), { size: u8() })],
      uri: [null, string()],
    })
...
export function findMarketV1Pda(
  ...
  seeds: {
    ...
    wallet: PublicKey;
    /** The index of the market in the user's markets. */
    index: number;
  },
): Pda {
  const programId = context.programs.getPublicKey(
