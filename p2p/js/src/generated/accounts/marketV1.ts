...
import type { AccountTypeArgs, Ratio, RatioArgs, State, StateArgs } from "../types";
import type {
  Account,
  Amount,
  Context,
...
export function getMarketV1GpaBuilder(context: Pick<Context, "rpc" | "programs">) {
  ...
  return gpaBuilder(context, programId)
    .registerFields<{
      ...
      index: [33, u32()],
      nextPosition: [37, u32()],
      resolver: [41, publicKeySerializer()],
      mint: [73, publicKeySerializer()],
      odds: [105, getRatioSerializer()],
      yesAmount: [113, u64()],
      noAmount: [121, u64()],
      state: [129, getStateSerializer()],
      creatorClaimed: [130, bool()],
      creationTimestamp: [131, i64()],
      closeTimestamp: [139, i64()],
      resolveTimestamp: [147, i64()],
      outcomeTimestamp: [155, i64()],
      platformFee: [163, mapAmountSerializer(u16(), "%", 2)],
      uri: [165, string()],
    })
