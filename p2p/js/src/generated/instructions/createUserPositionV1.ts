...
// Data.
export type CreateUserPositionV1InstructionData = {
...
> {
  return mapSerializer<
    ...
    CreateUserPositionV1InstructionData
  >(
    struct<CreateUserPositionV1InstructionData>(
      [
        ["discriminator", u8()],
        ["noAmount", u64()],
      ],
...
// Args.
export type CreateUserPositionV1InstructionArgs = CreateUserPositionV1InstructionDataArgs;

// Instruction.
export function createUserPositionV1(
  context: Pick<Context, "eddsa" | "identity" | "payer" | "programs">,
  input: CreateUserPositionV1InstructionAccounts & CreateUserPositionV1InstructionArgs,
): TransactionBuilder {
  // Program ID.
  ...
  // Arguments.
  const resolvedArgs: CreateUserPositionV1InstructionArgs = { ...input };
  ...
  // Data.
  const data = getCreateUserPositionV1InstructionDataSerializer().serialize(resolvedArgs);
