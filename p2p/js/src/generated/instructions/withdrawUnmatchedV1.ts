...
// Accounts.
export type WithdrawUnmatchedV1InstructionAccounts = {
  /** Market */
...
// Data.
export type WithdrawUnmatchedV1InstructionData = { discriminator: number };

export type WithdrawUnmatchedV1InstructionDataArgs = {};

export function getWithdrawUnmatchedV1InstructionDataSerializer(): Serializer<
  WithdrawUnmatchedV1InstructionDataArgs,
  WithdrawUnmatchedV1InstructionData
> {
  return mapSerializer<
    ...
    WithdrawUnmatchedV1InstructionData
  >(
    struct<WithdrawUnmatchedV1InstructionData>([["discriminator", u8()]], {
      description: "WithdrawUnmatchedV1InstructionData",
    }),
...
// Instruction.
export function withdrawUnmatchedV1(
  context: Pick<Context, "eddsa" | "identity" | "programs">,
  input: WithdrawUnmatchedV1InstructionAccounts,
): TransactionBuilder {
  // Program ID.
  ...
  // Data.
  const data = getWithdrawUnmatchedV1InstructionDataSerializer().serialize({});
