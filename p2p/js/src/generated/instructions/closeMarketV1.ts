...
// Accounts.
export type CloseMarketV1InstructionAccounts = {
  /** Market */
...
// Data.
export type CloseMarketV1InstructionData = { discriminator: number };

export type CloseMarketV1InstructionDataArgs = {};

export function getCloseMarketV1InstructionDataSerializer(): Serializer<
  CloseMarketV1InstructionDataArgs,
  CloseMarketV1InstructionData
> {
  return mapSerializer<CloseMarketV1InstructionDataArgs, any, CloseMarketV1InstructionData>(
    struct<CloseMarketV1InstructionData>([["discriminator", u8()]], {
      description: "CloseMarketV1InstructionData",
    }),
...
// Instruction.
export function closeMarketV1(
  context: Pick<Context, "eddsa" | "identity" | "programs">,
  input: CloseMarketV1InstructionAccounts,
): TransactionBuilder {
  // Program ID.
  ...
  // Data.
  const data = getCloseMarketV1InstructionDataSerializer().serialize({});
