...
// Accounts.
export type ClaimUserV1InstructionAccounts = {
  /** Market */
...
// Data.
export type ClaimUserV1InstructionData = { discriminator: number };

export type ClaimUserV1InstructionDataArgs = {};

export function getClaimUserV1InstructionDataSerializer(): Serializer<
  ClaimUserV1InstructionDataArgs,
  ClaimUserV1InstructionData
> {
  return mapSerializer<ClaimUserV1InstructionDataArgs, any, ClaimUserV1InstructionData>(
    struct<ClaimUserV1InstructionData>([["discriminator", u8()]], {
      description: "ClaimUserV1InstructionData",
    }),
...
// Instruction.
export function claimUserV1(
  context: Pick<Context, "eddsa" | "identity" | "programs">,
  input: ClaimUserV1InstructionAccounts,
): TransactionBuilder {
  // Program ID.
  ...
  // Data.
  const data = getClaimUserV1InstructionDataSerializer().serialize({});
